package com.sunny.mywifiapp.util;
...
//        BSSS，Base station signal strength，基站信号强度。
        ...
        LogUtil.i(TAG, "strength = " + strength);
        if (strength > 0) {
    ...
    public static List<ScanResult> getNeighboringWifiList(WifiManager mWifiManager){
        List<ScanResult> results = getWifiScanResults(mWifiManager);
        if (results == null) {
            LogUtil.d(TAG, "wifi扫描结果为空");
